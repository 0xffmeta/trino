            ...
            implements Iterable<List<Object>>
    {
        ...
        public CloseableIterator<List<Object>> iterator()
        {
            ...
            return new CloseableIterator<>() {
                private Iterator<DeleteFile> deleteFileIterator;

                @Override
                public boolean hasNext()
                {
                    return !closed && (planFilesIterator.hasNext() || (deleteFileIterator != null && deleteFileIterator.hasNext()));
                }

                @Override
                public List<Object> next()
                {
                    if (deleteFileIterator != null && deleteFileIterator.hasNext()) {
        ...
        private List<Object> getRecord(ContentFile<?> contentFile)
        {
            ...
            columns.add(contentFile.splitOffsets());
            columns.add(contentFile.equalityFieldIds());
